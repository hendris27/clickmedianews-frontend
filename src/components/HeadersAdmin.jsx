    ...
    <>
      <header className="flex justify-between items-center bg-white px-[50px] w-full fixed z-10 border-b-4">
          ...
          <div className="dropdown dropdown-bottom dropdown-end">
            ...
            >
                  ...
                  <div className="flex gap-8">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex justify-between">
                        <div>
                          <button className="bg-primary p-2 hover:bg-green-500 rounded-xl">Accept</button>
                        </div>
                        <div>
                          <button className="bg-blue-200 p-2 hover:bg-red-300 rounded-xl">Ignore</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <a className="hover:bg-white">
                  <div className="flex gap-8">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex justify-between">
                        <div>
                          <button className="bg-primary p-2 hover:bg-green-500 rounded-xl w-[70px]">View</button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <li className="font-bold text-primary">
                <a className="hover:bg-white hover:text-black">See More</a>
              </li>
            </ul>
          </div>
          <div className="p-2">
        ...
        <div className="items-center gap-8 font-bold hidden md:flex">
          ...
          <div>
            <Link to="/sign-in" className="hover:text-[#19A7CE] font-bold">
              Log In
            </Link>
          </div>
        </div>
