    ...
    return (
        <>
            <header className='flex justify-between items-center bg-white px-[50px] w-full fixed z-10 border-b-4'>
                ...
                <div className='flex font-bold gap-12 md:flex-block'>
                    <Link to='/home-admin' className='text-[#CDCDCD] hover:text-[#376AED] font-semibold'>
                        Home
                    </Link>
                    <Link
                        to=''
                        className='text-[#CDCDCD] hover:text-[#376AED] font-semibold'
                    >
                        Articles
                    </Link>
                ...
                <div className='flex gap-4 items-center'>
                    <div className='bg-white flex border-2 rounded-xl px-6 items-center gap-2 h-12'>
                        ...
                        <div>
                            <button className='pt-2'>
                                <MdOutlineClear size={20} color='#376AED' />
                            </button>
                        </div>
                    ...
                    <div className='dropdown dropdown-bottom dropdown-end'>
                        <label tabIndex={0} className='btn m-1 bg-white outline-none border-0 hover:bg-white '>
                            <MdNotificationsNone size={25} color='#376AED' />
                        </label>
                        <ul tabIndex={0} className='dropdown-content menu p-2 shadow  bg-base-100 rounded-box w-[400px] px-2s flex flex-col items-center justify-between '>
                            <li><a className='hover:bg-white'>
                                <div className='flex gap-8'>
                                    <div className='rounded-full overflow-hidden h-14 w-14 border-4 border-[#376AED]'>
                                        <img className='object-cover h-full w-full' src={profile} alt='' />
                                    </div>
                                    <div className='flex flex-col'>
                                        <div className='flex flex-col'>
                                            <div className='hover:text-[#376AED] font-bold'>Ryann just liked your post</div>
                                            <div>2m ago</div>
                                        </div>
                                        <div className='flex justify-between'>
                                            <div><button className='bg-primary p-2 hover:bg-green-500 rounded-xl'>Accept</button></div>
                                            <div><button className='bg-blue-200 p-2 hover:bg-red-500 rounded-xl' >Ignore</button></div>
                                        </div>
                                    </div>
                                </div>
                            </a></li>
                            ...
                            <li className='font-bold text-[#376AED]'><a className='hover:bg-white hover:text-black'>See More</a></li>
                        </ul>
                    </div>
                    <div className='p-2'>
                        <div className='rounded-full overflow-hidden h-14 w-14 border-4 border-[#376AED]'>
                ...
                <div className='flex items-center gap-8 font-bold hidden md:block md:flex'>
                    <div className='bg-[#376AED] rounded-[5px] w-24 h-8 flex items-center justify-center hover:bg-[#607ef9] '>
                    ...
                    <div>
                        <Link
                            to='/sign-in'
                            className='hover:text-[#376AED] font-bold'
                        >
                            Log In
                        </Link>
                    </div>
                ...
                <div className='dropdown dropdown-end md:hidden'>
                    <label tabIndex={0} className='btn m-1 bg-[#376AED]'>
