...
const Footers = () => {
    return (
        <>
            <div className='bg-[#19A7CE] px-[145px] py-[150px] '>
                <div className='flex justify-between text-medium'>
                    <div className='flex flex-col gap-7 text-[24px] font-medium text-white'>
                        <div>Why News Today</div>
                        <div>Be an author</div>
                        <div>Community</div>
                        <div>FAQ</div>
                    </div>
                    <div className='flex flex-col gap-7 font-medium text-white'>
