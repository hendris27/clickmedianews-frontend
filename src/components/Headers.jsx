        ...
        <>
            <header className="flex justify-between items-center bg-white px-[50px] w-full fixed z-10 border-b-4">
                <div className="h-[60px] w-[140px] flex items-center justify-center">
                    <Link
                        to="/"
                        className="text-[#CDCDCD] hover:text-[#3738dc] font-bold h-full w-full"
                    >
                ...
                <div className="font-bold gap-12 hidden md:flex">
                    <Link
                        ...
                        className={
                            location.pathname === '/'
                                ? 'active'
                                : 'text-[#CDCDCD] hover:text-[#3738dc] font-bold'
                        }
                    >
                        Home
                    </Link>
                    ...
                    >
                        {({
                            ...
                            <form
                                ...
                                className="bg-white flex border-2 rounded-xl px-6 items-center gap-2 h-12"
                            >
                                <div>
                                    <button type="submit">
                                        <BsSearch
                            ...
                            >
                                ...
                                <Link to="/notification">
                                    <li className="font-bold text-primary">
                                        <a className="hover:bg-white text-[#444cd4] hover:text-black">
                                            See More
                                        </a>
                                    </li>
                                </Link>
                            ...
                            <div className="dropdown dropdown-bottom dropdown-end">
                                ...
                                >
                                    <li>
                                        ...
                                        >
                                            <div className="font-bold text-medium hover:text-primary">
                                                See My Profile
                                            </div>
                                        </Link>
                                    </li>
