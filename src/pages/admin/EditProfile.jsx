        ...
        <>
            <div className="flex h-min-screen">
                    ...
                    <div>
                        <div className="w-[295px] h-[284px] shadow-2xl rounded-2xl bg-white relative">
                            ...
                            <div className="px-10">
                                ...
                                <div>
                                    Madison Blackstone is a director of
                                    publisher, with experience managing global
                                    teams.
                                </div>
                            </div>
                ...
                <div className="flex">
                    ...
                    <Link>
                        <h1 className="text-[16px] mt-[110px] ml-[100px] text-[#376AED] font-semibold">
                            save changes
                        </h1>
                    </Link>
                ...
                <div className="mt-[300px] ml-[-700px]">
                    <h1 className="text-[16px] mt-[25px] ml-[120px]">
                        Username :
                    </h1>
                    <input
                        type="text"
                ...
                <div>
                    <h1 className="text-[16px] mt-[430px] ml-[-300px]">
                        Email :
                    </h1>
                    <input
                        type="email"
                ...
                <div>
                    <h1 className="text-[16px] mt-[530px] ml-[-300px]">
                        Job :
                    </h1>
                    <input
                        type="text"
                ...
                <div>
                    <h1 className="text-[16px] font-semibold mt-[325px] ml-[120px]">
                        Name :
                    </h1>
                    <input
                        type="text"
