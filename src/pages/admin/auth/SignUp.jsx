      ...
      <div className="flex w-full h-full xl:h-screen">
        <section className="flex w-[600px] h-[100vh] md:flex max-sm:hidden bg-[#376AED]">
          ...
          <div>
            ...
            <Link>
              <h1 className="text-white mt-[70px] ml-[-150px]">Why Click News</h1>
            </Link>
            <Link>
              <h1 className="text-white mt-[20px] ml-[-150px]">Community</h1>
            </Link>
            <Link>
              <h1 className="text-white mt-[-70px] ml-[200px]">Be an Author</h1>
            </Link>
            <Link>
              <h1 className="text-white mt-[20px] ml-[200px]">FAQ</h1>
            </Link>
          </div>
        </section>
        <section>
          <div className="flex">
            <h1 className="text-black text-[30px] font-bold mt-[20px] ml-[120px]">Sign Up</h1>
          </div>
          <h1 className="text-slate-400 text-[14px] mt-[10px] ml-[120px]">
            Hey, welcome to Click News ! Create an account to enjoy our full feautres!
          </h1>
          <div>
          ...
          <Link>
            <img className="w-[35px] mt-[20px] ml-[180px]" src={google} />
          </Link>
          <Link>
            <img className="w-[35px] mt-[-35px] ml-[260px]" src={facebook} />
          </Link>
          <Link>
            <img className="w-[35px] mt-[-35px] ml-[340px]" src={twitter} />
          </Link>
        </section>
      </div>
    </>
