                    ...
                    <div className="flex items-center flex-col justify-center gap-10 h-screen">
                        <div className="flex gap-5 w-4/5">
                            <Link className="flex gap-5" to>
                                ...
                                <div className="font-bold mt-[-5px] text-lg text-black">
                                    Back
                                </div>
                            </Link>
                        </div>
                        <div className="flex flex-col w-4/5 gap-8 items-center">
                            <div>
                                <div className="text-[36px] mt-[-20px] uppercase font-bold text-black">
                                    Don`t Worry
                                </div>
                                <div className="text-gray-500">
                                    We are here to help you to recover your
                                    password. Enter your email address that you
