            ...
            <div className="absolute top-0 left-0 flex flex-col  md:flex md:flex-row  bg-no-repeat bg-cover ">
              <div className="flex flex-col h-full  gap-8 pl-[136px] pt-[100px] pb-[70px] ">
                ...
                <div className="text-[20px] w-[608px] leading-[32px] ">
                  Everyone has their point of view of something, but just don’t be afraid to express the facts. Be an
                  author and share you prespective of something to the world.
                </div>
