...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        async function getArticleManage() {
            try {
                const articleManage = await http(token).get(
                    '/articles/manage?limit=100'
                )
        ...
        async function getComment() {
            try {
                const dataComment = await http().get(
                    `/article-comments/total/${user.id}`
                )
            ...
            <div className="h-min-screen">
                ...
                <div className="flex">
                    <div className="w-[500px] p-24  flex flex-col gap-10">
                        <div>
                            <p className="text-[24px] mt-[40px] font-bold">
                                Profile
                            </p>
                        </div>
                        <div>
                        ...
                        <div className="w-full flex justify-center">
                            <Link
                                to="/profile"
                                className="text-primary font-bold hover:text-[17px] "
                            >
                                See Profile
                            </Link>
                        </div>
