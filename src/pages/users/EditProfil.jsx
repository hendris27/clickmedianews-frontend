        ...
        <div className="flex">
          <div className="w-[500px] p-24  flex flex-col gap-10">
                ...
                <div className="flex gap-5 items-center w-full h-[120px] px-10">
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <div className="font-bold">
                      {profile?.fullName === null ? 'Name is not set' : profile?.fullName}
                    </div>
            ...
            <div className="w-full flex justify-center">
              <Link to="/profile" className="text-primary font-bold hover:text-[17px] ">
                See Profile
              </Link>
            </div>
          ...
          <div className=" pt-28 flex-1">
            <Formik
              initialValues={{ username: '', fullName: '', email: '', password: '', profession: '', about: '' }}
                  ...
                  <form className="pb-24" onSubmit={handleSubmit}>
                    <div className="flex justify-between px-[60px]">
                      ...
                      <div>
                        <div className="border-2 rounded-3xl border-blue-500 p-2 flex justify-center items-center">
                          <div className="rounded-3xl border-2 border-gray-50 overflow-hidden w-[144px] h-[150px] ">
                            {selectedPicture && <img src={pictureURI} className="object-cover h-full w-full" />}
                            {profile.picture === null ? (
                              <img src={defaultPicture} className="object-cover h-full w-full" />
                            ) : (
                              <img src={profile.picture} className="object-cover h-full w-full" />
                      ...
                      <div>
                        <button
                          type="submit"
                          className="text-[18px] font-bold text-primary hover:text-black"
                    ...
                    <div className="flex justify-between px-[60px] ">
                      ...
                      <div className="form-control w-full max-w-xs">
                        ...
                        <input
                          ...
                          name="about"
                          placeholder="About"
                          className="input input-bordered w-full  h-[115px] max-w-xs"
                          onChange={handleChange}
                          onBlur={handleBlur}
                          value={values.about}
                        />
                    ...
                    <div className="flex justify-center mt-32">
                      {user !== 'superadmin' && (
                        <div className="mb-24 flex flex-col gap-3">
                          {statusMassage && (
                            <span className="text-center text-info flex gap-2 items-center">
                          ...
                          {profile.isAuthor === false ? (
                            ...
                            <div className="h-12 px-6 py-3 flex justify-center items-center gap-2 bg-[#19A7CE] rounded-xl text-white">
