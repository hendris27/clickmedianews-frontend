                        ...
                        <div className='flex flex-1 flex-col gap-14'>
                            ...
                            <div>
                                <div className='font-bold'>
                                    {article?.fullName} - Author
                                </div>
                                <div>
                                    {moment(article?.createdAt).format("MMMM Do YYYY, h:mm")}
                                </div>
                            </div>
                            <div className='flex gap-5 items-center'>
                                ...
                                <button onClick={createSavePost}>
                                    <img src={Save} alt='' />
                                </button>
                            </div>
                            <div className='w-full flex flex-col gap-3'>
                                {user !== "superadmin" && (
                                    <button className='btn normal-case w-full font-bold max-w-full'>
                                        Share Article Link
                                    </button>
                                )}
                                {user === "superadmin" && (
                                    <div className='flex flex-col gap-3'>
                                        {edit === true ? (
                                            <button
                                                onClick={saveButton}
                                                className='btn normal-case w-full font-bold max-w-full'
                                            >
                                                Save article
                                            </button>
                                        ) : (
                        ...
                        <div className='flex flex-col gap-8'>
                            ...
                            <div className='flex gap-5'>
                                ...
                                <div className='flex flex-col gap-3 w-full'>
                                    ...
                                    ></textarea>
                                    <button className='btn bg-primary border-none normal-case text-white max-w-xs'>
                                        Submit
                                    </button>
                                </div>
                            </div>
