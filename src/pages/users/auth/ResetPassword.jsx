                      ...
                      <div>
                        <input
                          ...
                          className={`input input-bordered w-full bg-white border-2 mb-2 border-gray-400 text-black max-w-2xl border' ${
                            errors.code && touched.code && 'input-error border-red-700'
                          }`}
                        ...
                        {errors.code && touched.code && (
                          <label htmlFor="code" className="label p-0">
                            <span className="label-text-alt font-bold text-md text-error">{errors.code}</span>
                          </label>
                        )}
                      </div>
                      <div>
                        <input
                          ...
                          name="email"
                          className={`input input-bordered w-full bg-white border-2 mb-2 border-gray-400 text-black max-w-2xl border' ${
                            errors.email && touched.email && 'input-error border-red-700'
                          }`}
                          onChange={handleChange}
                          onBlur={handleBlur}
                          value={values.email}
                      ...
                      <div>
                        <div className="relative">
                          <input
                            ...
                            name="password"
                            className={`input input-bordered w-full bg-white border-2 mb-2 border-gray-400 text-black max-w-2xl border' ${
                              errors.password && touched.password && 'input-error border-red-700'
                            }`}
                            onChange={handleChange}
                            onBlur={handleBlur}
                          ...
                          <button type="button" onClick={showEye}>
                            {open ? (
                              <FaEye size={25} className="absolute top-3 right-5" />
                            ) : (
                              <FaEyeSlash size={25} className="absolute top-3 right-5" />
                            )}
                          </button>
                        </div>
                      ...
                      <div>
                        <div className="relative">
                          <input
                            ...
                            className={`input input-bordered w-full bg-white border-2 mb-2 border-gray-400 text-black max-w-2xl border' ${
                              errors.confirmPassword && touched.confirmPassword && 'input-error border-red-700'
                            }`}
                            onChange={handleChange}
                            onBlur={handleBlur}
