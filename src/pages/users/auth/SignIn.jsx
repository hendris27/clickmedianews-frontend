                    ...
                    <div className="flex items-center flex-col justify-center gap-3">
                            ...
                            {({
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {formError && (
                                            <div>
                                                <div className="alert alert-error font-bold danger text-[15px]">
                                                    {formError}
                                                </div>
                                            </div>
                                        )}
                                        {successMessage && (
                                            <div>
                                                <div className="alert alert-success text-[11px]">
                                                    {successMessage}
                                                </div>
                                            </div>
                                        )}
                                        ...
                                        <div>
                                            <button
                                                ...
                                                className="btn bg-primary text-white border-0 w-full normal-case"
                                            >
                                                Login
                                            </button>
                                        </div>
                        ...
                        <div className="flex flex-col items-center gap-3 w-[43%]">
                            ...
                            <div className="w-full">
                                <Link
                                    to="/signup"
                                    className="btn text-white border-0 w-full normal-case"
                                >
                                    Sign Up Now
                                </Link>
                            </div>
