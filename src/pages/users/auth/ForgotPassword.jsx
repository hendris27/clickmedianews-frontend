          ...
          <div className="flex items-center flex-col justify-center gap-10 h-screen">
            <div className="flex gap-4 w-4/5">
              <Link to="/signin" className="flex gap-5">
                <img src="/src/assets/img/arrow-back.svg" className="w-2" />
                <div className="font-bold text-lg text-black">Back</div>
              </Link>
            </div>
            <div className="flex flex-col w-4/5 gap-10 items-center">
              <div>
                <div className="text-[36px] uppercase font-bold text-black">Don&apos;t worry</div>
                <div className="text-black">
                  We are here to help you to recover your password. Enter your email adress that you used to register
                ...
                {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
                  <>
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-3/4">
                      ...
                      <div>
                        <button className="btn w-full uppercase bg-primary border-0 text-white" type="submit">
                          Resend Link
                        </button>
                      </div>
                    </form>
