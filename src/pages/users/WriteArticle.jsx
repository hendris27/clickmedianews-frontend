    ...
    <>
      ...
      <div className="pt-36 px-32 pb-24">
        <div className="flex flex-col gap-8">
          ...
          {successMessage && (
            <div className="flex flex-row justify-center alert alert-info shadow-lg text-white text-lg my-3">
                ...
                <div className="flex gap-8">
                  <div className="w-[342px] h-[535px]  border-4 p-4 rounded-xl ">
                    <div className="w-full h-full border-4 border-dashed flex justify-center items-center rounded-xl">
                      {selectedPIcture ? (
                        <img src={pictureURI} alt="Selected Cover Photo" className="w-full h-full object-cover" />
                      ) : (
