          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-1">
              ...
              {status === true ? (
                ...
                <span className="text-primary">Status: Request Publish</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className=" flex justify-between bg-secondary ">
          <div className="w-[50%] px-[150px] pt-24 pb-24 flex flex-col items-center gap-16 ">
            ...
            <div className="flex flex-col gap-4">
              <div>
                <button className="btn btn-primary min-w-[295px] text-white">Messages</button>
              </div>
              <div>
                <button className="btn btn-gray-400 min-w-[295px] hover:bg-primary ">Following</button>
              </div>
              <div>
