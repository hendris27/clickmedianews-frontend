                    ...
                    <div className='w-full relative'>
                        ...
                        <div className='absolute top-0 left-0 flex flex-col  md:flex md:flex-row  bg-no-repeat bg-cover '>
                            <div className='flex flex-col h-full  gap-8 pl-[136px] pt-[100px] pb-[70px] '>
                                ...
                                <div className='bg-[#376AED] hover:bg-[#4d7cf3] w-[172px] h-16 rounded-xl text-[20px] flex items-center justify-center '>
                    ...
                    <div className='flex flex-col bg-white px-[60px] pt-[60px] pb-[101px]  '>
                        <div className='flex flex-col gap-8'>
                            <div className='flex justify-between font-semibold'>
                                <div>Popular</div>
                                <div className='text-[#376AED]'>More</div>
                            </div>
                            <div className='flex gap-16 font-semibold text-[#376AED] cursor-pointer '>
                            ...
                            <div className='flex flex-col gap-8 pt-[20px]'>
                                ...
                                <div className='flex gap-8'>
                                    <div className='flex flex-col items-center gap-4 drop-shadow-2xl cursor-pointer'>
                                        ...
                                        <div className='pl-8'>
                                            <div className='flex flex-col gap-8' >
                                                <div className='flex flex-col gap-4'>
                                                    <div className='text-[#376AED] text-[20px] leading-[20px] '>COVID-19</div>
                                                ...
                                                <div className='flex gap-4'>
                                                    ...
                                                    <div className='flex items-center'>
                                                        <BsFillBookmarkFill color='#376AED' />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className='bg-[#D7DDEC] pl-[155px] pt-[135px] pb-[175px]'>
                        <div className='flex gap-16'>
                            <div className='flex flex-col gap-8'>
                                ...
                                <div className='bg-[#376AED] hover:bg-[#4d7cf3] w-[180px] h-16 flex items-center justify-center rounded-xl'>
                                        ...
                                        <div className='pl-8'>
                                            <div className='flex flex-col gap-8' >
                                                ...
                                                <div className='flex gap-4'>
                                                    ...
                                                    <div className='flex items-center'><BsFillBookmarkFill color='#376AED' /></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
