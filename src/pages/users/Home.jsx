                        ...
                        <div className="absolute top-0 left-0 flex flex-col  md:flex md:flex-row  bg-no-repeat bg-cover ">
                            <div className="flex flex-col h-full  gap-12 pl-[136px] pt-[100px] pb-[70px] ">
                                <div className="flex flex-col">
                                    <div className="text-[65px] md:w-[668px] lg:w-[800px] leading-[74px] ">
                                        Share Information
                                    </div>
                                    <div className="text-[65px] md:w-[668px] lg:w-[800px] leading-[74px] ">
                                        and Educate People
                                ...
                                <div className="text-[20px] w-[608px] leading-[32px] ">
                                    Everyone has their point of view of
                                    something, but just don’t be afraid to
                                    express the facts. Be an author and share
                    ...
                    <div className="flex flex-col bg-white px-[60px] pt-[60px] pb-[101px]  ">
                        <div className="flex flex-col gap-8">
                            <div className="flex justify-between font-semibold">
                                <div>Popular</div>
                                <div className="text-[#444cd4] cursor-pointer">
                                    More
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-8">
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="font-medium">
                                        See how well News Today works in a{' '}
                                        <br /> real user&apos; life.{' '}
                                    </div>
                                </div>
                        ...
                        <div className="flex gap-16">
                            ...
                            <div className="flex flex-col gap-8">
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="font-bold text-[36px] leading-[56px]  ">
                                        You tell us some facts, <br /> We help
                                        you to make your <br /> article
                                    </div>
                                    <div className="font-medium">
                                        Everyone has their own facts, and in
                                        different ways. <br />
                                        Let Click News helps you to be a good
                                        author to <br />
                                        educate people just by reading your
                                        article.
                                    </div>
                                </div>
                                <div className="bg-[#444cd4] hover:bg-[#6261df] text-white w-[180px] h-16 flex items-center justify-center rounded-xl">
