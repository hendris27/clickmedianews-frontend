        ...
        <div className="pt-20">
          <div className="flex h-auto">
            <div className="max-w-[500px] border-r-2 p-20 flex flex-col gap-10">
              ...
              <div>
                <div className="mb-2 text-center w-[295px] text-slate-400">Click profile card to see profile</div>
                    ...
                    <div className="border-2 rounded-3xl border-blue-500 p-1">
                      <div className="rounded-3xl border-2 border-gray-50 overflow-hidden w-16 h-16">
                        {profile.picture === null ? (
                          <img src={defaultPicture} className="object-cover h-full w-full" alt="" />
                        ) : (
                          <img src={profile.picture} className="object-cover h-full w-full" alt="" />
                        )}
                      </div>
                    </div>
            ...
            <div className="flex flex-col flex-1 items-center mt-20 gap-10">
              ...
              <div className="w-full flex flex-wrap gap-5 justify-center">
                {savePost.map((savedArticle) => (
                  <div key={`saved-article-${savedArticle.id}`} className="w-[380px] h-[200px] rounded-lg shadow-xl">
                    <div>
                      <div className="flex gap-5">
                        <img
                          src={savedArticle.picture}
                          className="w-[126px] h-[200px] object-cover rounded-lg"
                          alt=""
                        />
                        <div className="flex flex-col gap-3">
                          ...
                          <Link to={`/articleview/${savedArticle.id}`} className="text-sm">
                            {savedArticle.descriptions}
                          </Link>
